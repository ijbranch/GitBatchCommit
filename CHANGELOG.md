...
- `ELExtraPlugIns` was referenced outside the project's `{$IFDEF EurekaLog}` conditional, so a non-EurekaLog build still pulled it in (2026-08-30) — `GitBatchCommit.dpr`
